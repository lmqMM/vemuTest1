...
import json
from deployment.ovs import OVSSwitch
...
class DockerNet():
    ...
    def __init__(self, name, topo):
        ...
        print("DockerNet name: " + self.name)
        ...
        for key in hosts:
            ...
            container = client.containers.create(image=hosts[key]['hostType'], name=key,
                                              command="/bin/bash",
                                              cpuset_cpus="0,1",
                                              cpu_shares=2,
                                              cpu_period=100000,
